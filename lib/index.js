...
var ClampLines = function (_PureComponent) {
  ...
  function ClampLines(props) {
    ...
    _this.ssr = typeof _window2.default !== 'undefined' ? true : false;
  ...
  _createClass(ClampLines, [{
    ...
    value: function componentDidMount() {
      if (typeof _window2.default !== 'undefined') {
        ...
        if (this.watch) {
          _window2.default.addEventListener('resize', this.debounced);
        }
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      if (typeof _window2.default !== 'undefined') {
        _window2.default.removeEventListener('resize', this.debounced);
      }
      this.action = null;
